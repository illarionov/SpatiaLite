...
case 5:
YY_RULE_SETUP
{ gml_saveString(&(GmlLval.pval), yytext); return GML_COORD; }
	YY_BREAK
case 6:
...
case 7:
YY_RULE_SETUP
{ gml_saveString(&(GmlLval.pval), yytext); return GML_KEYWORD; }
	YY_BREAK
case 8:
YY_RULE_SETUP
...
static int yy_get_next_buffer (yyscan_t yyscanner)
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					Gmlrealloc((void *) b->yy_ch_buf,b->yy_buf_size + 2 ,yyscanner );
				}
			else
	...
	if ((yy_size_t) (yyg->yy_n_chars + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) Gmlrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,new_size ,yyscanner );
...
void Gmlset_debug (int  bdebug , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
